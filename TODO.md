...
- [x] **TV 드라마/애니메이션 분류 시스템** ✅
  - [x] 파일명 기반 자동 분류
  - [x] 릴리즈 그룹 기반 분류 (SubsPlease, Netflix, HBO 등)
  - [x] 키워드 기반 분류 (anime, drama, 화, 시즌 등)
  - [x] 언어 정보 기반 분류 (한국어, 일본어)
  - [x] 에피소드 패턴 기반 분류 (화, SxxEyy, 1x01 등)
  - [x] 애니메이션 제목 키워드 분류 (Attack on Titan, Ghost in the Shell 등)
  - [x] 점수 기반 정교한 분류 시스템
  - [x] 분류 정확도 테스트 및 검증
