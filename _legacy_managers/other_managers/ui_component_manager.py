...
class UIComponentManager:
    ...
    def __init__(self, main_window: QMainWindow):
        ...
        self.event_handler_manager: CoreEventHandlerManager | None = None
    ...
    def _setup_event_handler_manager(self):
        ...
        try:
            if hasattr(self.main_window, "event_bus") and self.main_window.event_bus:
                self.event_handler_manager = CoreEventHandlerManager(self.main_window)
                self.main_window.event_handler_manager = self.event_handler_manager
                self.event_handler_manager.setup_main_window_connections()
