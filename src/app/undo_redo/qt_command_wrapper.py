...
class QtDeleteFileCommand(QtCommandWrapper):
    ...
    def __init__(
        self, file_path: str | Path, use_trash: bool = True, parent: QUndoCommand | None = None
    ):
...
class QtBatchFileCommand(QtCommandWrapper):
    ...
    def __init__(
        self, commands: list[ICommand], description: str = "", parent: QUndoCommand | None = None
    ):
