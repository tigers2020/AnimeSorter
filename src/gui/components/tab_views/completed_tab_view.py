"""
완료 탭 뷰 클래스 - Phase 2.1 결과 뷰 컴포넌트 분할
완료 탭의 UI와 로직을 담당하는 독립적인 클래스입니다.
"""
...
class CompletedTabView(QWidget):
    """완료 탭 뷰 클래스"""
    ...
    def _create_group_section(self):
        ...
        self.group_table.setToolTip(
            "완료된 애니메이션 그룹 목록 - 제목에 마우스를 올리면 포스터를 볼 수 있습니다"
        )
