...
from ..commands.file_commands import ChooseFilesCommand, ChooseFolderCommand, StartScanCommand, StopScanCommand
from ..commands.tmdb_commands import StartTMDBSearchCommand, SelectTMDBAnimeCommand, SkipTMDBGroupCommand
from ..commands.organize_commands import StartOrganizeCommand, CancelOrganizeCommand
...
class ComponentFactory:
    ...
    def register_controller(self, name: str, controller_class: Type[IController], 
    ...
    def register_view_model(self, name: str, view_model_class: Type[IViewModel], 
                           singleton: bool = True) -> None:
        """
        뷰모델 등록
    ...
    def create_controller(self, name: str, config: Optional[Dict[str, Any]] = None) -> IController:
        """
        컨트롤러 생성
    ...
    def create_service(self, name: str, config: Optional[Dict[str, Any]] = None) -> IService:
        """
        서비스 생성
    ...
    def create_view_model(self, name: str, config: Optional[Dict[str, Any]] = None, 
                         parent=None) -> IViewModel:
        """
        뷰모델 생성
    ...
    def create_command(self, name: str, config: Optional[Dict[str, Any]] = None, 
                      **kwargs) -> BaseCommand:
        """
        명령 생성
    ...
    def get_controller(self, name: str) -> Optional[IController]:
        """컨트롤러 인스턴스 가져오기"""
    ...
    def get_view_model(self, name: str) -> Optional[IViewModel]:
        """뷰모델 인스턴스 가져오기"""
