...
class AnimeDataManager(QObject):
    ...
    tmdb_anime_selected = pyqtSignal(str, object)  # TMDB 애니메이션 선택됨 (group_id, TMDBAnimeInfo)
    ...
    def get_item_by_id(self, item_id: str) -> Optional[ParsedItem]:
        """ID로 아이템 찾기"""
    ...
    def get_tmdb_match_for_group(self, group_id: str) -> Optional[TMDBAnimeInfo]:
        """그룹의 TMDB 매치 결과 반환"""
