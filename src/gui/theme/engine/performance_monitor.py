...
class PerformanceMonitor:
    ...
    def _trigger_performance_alert(self, metric: PerformanceMetric, 
    ...
    def record_operation(self, operation_name: str, start_time: float, 
    ...
    def export_performance_report(self, output_path: Optional[Path] = None) -> str:
        ...
        try:
            report = {
                ...
                'recent_snapshots': [snapshot.to_dict() for snapshot in self.snapshots[-10:]],  # 최근 10개
                'thresholds': {
                    name: {
                        'warning_threshold': threshold.warning_threshold,
                        'critical_threshold': threshold.critical_threshold,
    ...
    def decorator(func):
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                monitor.record_operation(operation_name, start_time, success=False, error_message=str(e))
                raise
        return wrapper
    return decorator
