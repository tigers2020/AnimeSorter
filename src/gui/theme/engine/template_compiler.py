...
class TemplateCompiler:
    ...
    def compile_template(self, template_content: str, template_name: str = "", 
    ...
    def validate_template(self, template_content: str) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                validation_result['stats']['total_rules'] = len(ast_node.find_nodes_by_type(NodeType.RULE))
                validation_result['stats']['total_properties'] = len(ast_node.find_nodes_by_type(NodeType.PROPERTY))
                validation_result['stats']['total_variables'] = len(ast_node.find_nodes_by_type(NodeType.VARIABLE))
            except Exception as e:
...
def compile_template(template_content: str, templates_dir: Optional[Path] = None,
                    context: Optional[Dict[str, Any]] = None) -> str:
    """템플릿을 컴파일합니다"""
