...
class DetailViewModel(QObject, IViewModel):
    ...
    def __init__(self, event_bus: IEventBus, parent=None):
        ...
        # 현재 선택된 그룹
        self._selected_group_key: Optional[str] = None
        self._detail_info: Optional[DetailInfo] = None
    ...
    def get_detail_info(self) -> Optional[DetailInfo]:
        """상세 정보 반환"""
    ...
    def get_tmdb_match(self) -> Optional[TMDBAnimeInfo]:
        """TMDB 매치 반환"""
        if self._detail_info:
