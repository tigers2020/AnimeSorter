...
class MainWindowViewModel(QObject, IViewModel):
    ...
    def _update_ui_state(self):
        ...
        # 버튼 활성화 상태 업데이트
        self._ui_state.can_start_scan = not (self._ui_state.is_scanning or 
                                           self._ui_state.is_searching or 
                                           self._ui_state.is_organizing)
        
        self._ui_state.can_start_search = (self._ui_state.has_parsed_items and 
                                          not self._ui_state.is_scanning and
                                          not self._ui_state.is_searching and
                                          not self._ui_state.is_organizing)
        
        self._ui_state.can_start_organize = (self._ui_state.has_selected_items and
                                            self._ui_state.has_tmdb_matches and
                                            not self._ui_state.is_scanning and
                                            not self._ui_state.is_searching and
                                            not self._ui_state.is_organizing)
